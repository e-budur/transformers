            ...
            if (step + 1) % args.gradient_accumulation_steps == 0 and not args.tpu:
                ...
                if args.local_rank in [-1, 0] and args.logging_steps > 0 and global_step % args.logging_steps == 0:
                    ...
                    if (
                        ...
                        eval_results = evaluate(args, model, tokenizer, processor, only_scalars=True, verbose=True)
...
def evaluate(args, model, tokenizer, processor, prefix='', only_scalars=True, verbose=True):
...
def main():
    ...
    num_enumerable_entity_labels = len(enumerable_entity_labels)
    num_non_enumerable_entity_labels = len(non_enumerable_entity_labels)
    ...
    config = config_class.from_pretrained(args.config_name if args.config_name else args.model_name_or_path,
                                          ...
                                          num_enumerable_entity_labels=num_enumerable_entity_labels,
                                          num_non_enumerable_entity_labels=num_non_enumerable_entity_labels,
