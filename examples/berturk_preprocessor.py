...
def tokenize_with_sentencepiece(sp_model, text):
    output_ids = sp_model.SampleEncodeAsIds(text, alpha=0.75, nbest_size=-1)# TODO: the hyperparameters alpha and nbest_size should be bound to the input arguments.
