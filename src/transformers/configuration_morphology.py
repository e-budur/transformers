...
class BertMorphologyConfig(PretrainedConfig):
    r"""
        This is the configuration class to store the configuration of an :class:`~transformers.BertModel` leveraging a morphology parser as the input form.
