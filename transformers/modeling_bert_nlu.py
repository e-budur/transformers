...
class BertNLUForSequenceClassification(BertForSequenceClassification):
    r"""
    ...
    """
    def __init__(self, config):
        super(BertNLUForSequenceClassification, self).__init__(config)
    ...
    def forward(self, input_ids=None, attention_mask=None, token_type_ids=None,
        ...
        outputs = (logits,) + outputs[3:]  # add hidden states and attention if they are here (skipping multi label head)
